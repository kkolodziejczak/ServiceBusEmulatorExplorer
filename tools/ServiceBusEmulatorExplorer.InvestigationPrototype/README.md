...
Connection strings remain masked in Settings. Use the adjacent Copy button to share the current runtime or administration string; blank fields cannot be copied. The toolbar has a thin top accent and a subtle neutral gray divider below, and scrollbars share the profile theme throughout the prototype.
