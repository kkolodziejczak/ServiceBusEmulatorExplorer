...
4. Clear filter/Show all restores both complete trees, preserving draft/template identity. Do not immediately reapply the retained selection. A later explicit selection can filter again. Clearing browsing scope does not erase a still-valid visible target or grant approval.
