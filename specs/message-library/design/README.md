...
The Saved templates, Prepare, and Review footer dividers align at wide and compact sizes. The Review notice sits above its fixed action row, with Back on the left and Send on the right.
